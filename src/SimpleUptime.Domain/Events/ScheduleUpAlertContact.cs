...
{
    public class ScheduleUpAlertContact : IEvent
    {
        public ScheduleUpAlertContact(AlertContactId alertContactId, HttpMonitorId httpMonitorId, MonitorStatus previousStatus, DateTime startTime, DateTime created)
        {
